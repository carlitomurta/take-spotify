...
API enabling natural URL style (like `localhost:4200/profile/`), in opposition to Angular 1 which used the _hashbang_ hack
routing style (like `localhost:4200/#/profile/`).
